...
class ErrsoleMongoDB {
  ...
  async ensureCollections () {
    ...
    await this.db.collection(this.logsCollectionName).createIndex({ _id: 1, source: 1, level: 1 });
    await this.db.collection(this.logsCollectionName).createIndex({ timestamp: 1, source: 1, level: 1 });
